...
<body>
    <div class="main-container">
        <div class="center-container">
            ...
            <div class="user-half">
                ...
                <!-- heading -->
                <h2 class="heading">Worker Login ...</h2>
                <!-- form -->
            ...
            <div class="register-half">
                <h2 class="heading">Worker Registration ...<br></h2>
                </h2>
    ...
    <script>
        ...
        $(".t-login").click(function() {
            $(".user-half").css("display", "none");
            $(".register-half").css("display", "flex");
        });

        $(".s-login").click(function() {
            $(".register-half").css("display", "none");
            $(".user-half").css("display", "flex");
        });
    </script>
